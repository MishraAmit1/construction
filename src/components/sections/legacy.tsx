...
export function Legacy() {
  ...
  return (
    <section className="bg-white font-apfel2 py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 bg-background overflow-hidden">
      <div className="mx-auto pr-4 lg:pr-0 pl-4 sm:pl-8 md:pl-12 lg:pl-20 xl:pl-28 mt-8 sm:mt-12 md:mt-16 lg:mt-20">
        {/* Responsive grid */}
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr] items-start gap-8 md:gap-12 lg:gap-16 xl:gap-24">
          ...
          <div className="lg:-mt-20 xl:-mt-32 text-[#30454c]">
            <h2
              className="font-apfel2 text-[1.75rem] sm:text-[2.5rem] md:text-[3rem] lg:text-[3.75rem]
                         leading-[1.15] sm:leading-[1.1] lg:leading-[1.05] font-normal text-gray-900"
            >
