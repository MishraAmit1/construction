...
export function WhereWeWork() {
    ...
    return (
        <section className="py-16 sm:py-24 bg-secondary/30 overflow-x-hidden">
            <div className="w-full">
                {/* Header with padding */}
                <div className="mb-28 px-4 sm:px-6 lg:px-32 ">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
                        {/* Left Heading */}
                        <h2 className="font-headline text-4xl lg:text-6xl font-semibold text-primary leading-tight">
                            Where We Work
                        </h2>

                        {/* Right Paragraph with restricted width */}
                        <p className="text-base sm:text-lg text-foreground/80 leading-relaxed max-w-2xl ml-auto">
                ...
                {/* Pagination counter */}
                <div className="flex items-center justify-start gap-4 mt-8 lg:px-28 pb-28">
                    <button
                ...
                <div className="mt-36 px-6 sm:px-10 lg:px-28">
                    <div className="relative w-full overflow-hidden rounded-xl shadow-lg">
                        <video
                            src="https://www.bechtel.com/wp-content/uploads/2025/01/project-page-BOTTOM-footage.mp4"
                            autoPlay
                            loop
                            muted
                            playsInline
                        ...
                        />
                        {/* Optional dark overlay for cinematic tone */}
