...
export default function MajorClients({ clients }: MajorClientsProps) {
    ...
    return (
        <section className="font-apfel2 py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-between relative">
                    ...
                    <button
                        onClick={handlePrev}
                        className={cn(
                            'hidden sm:flex p-2 sm:p-2.5 md:p-3 border border-gray-300 rounded-md z-20 bg-white',
                            'hover:bg-red-600 hover:text-white hover:border-red-600 transition-all duration-200 flex-shrink-0',
                    ...
                    >
                        <div
                            ...
                            style={
                                !isMobile && clients.length > visibleCount
