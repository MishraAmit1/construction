                                    ...
                                    <div className="lg:col-span-2">
                                        <article className="bg-white rounded-xl overflow-hidden h-full">
                                            ...
                                            <div className="p-6 lg:p-8">
                                                ...
                                                <h3 className="text-2xl sm:text-3xl md:text-4xl font-apfel2 font-normal leading-tight text-gray-900 mb-4 hover:text-red-600 transition-colors">
                                                    ...
                                                    <div className="flex h-full">
                                                        ...
                                                        <div className="flex-1 p-4 lg:p-5 flex flex-col justify-between">
                                                            <div>
                                                                ...
                                                                <h4 className="text-sm lg:text-base font-apfel2 font-normal text-gray-900 line-clamp-3 hover:text-red-600 transition-colors">
