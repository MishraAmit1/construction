        ...
        <div id="markets" className="lg:col-span-5 grid grid-cols-1 gap-6">
          {markets.map((m, idx) => (
            ...
            >
              ...
              <Link
                href={m.href || "#"}
                className="absolute bottom-3 right-3 z-10 inline-flex h-10 w-10 items-center justify-center rounded-full bg-red-600 text-white shadow-lg transition-transform duration-200 hover:scale-110"
        ...
        <div id="projects" className="lg:col-span-7 grid sm:grid-cols-2 gap-6">
          {projectCards.map((p, idx) => (
            ...
            >
              ...
              <Link
                href={p.href || "#"}
                className="absolute bottom-3 right-3 z-10 inline-flex h-9 w-9 items-center justify-center rounded-full bg-red-600 text-white shadow-lg transition-transform duration-200 hover:scale-110"
