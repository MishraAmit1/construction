...
const serviceDetailsData: Record<string, ServiceDetail> = {
    "engineering": {
        ...
        keyFeatures: [
            {
                ...
                description: "Engineering hubs in Taiwan, Dubai, New Delhi, and major cities worldwide"
            },
            {
                icon: Zap,
                title: "Advanced Technology",
                description: "3D/4D/5D modeling, AI-driven design optimization, and digital twins"
            },
            {
                icon: Users,
                title: "Expert Teams",
            ...
            },
            {
                ...
                description: "Design with supply chain, construction, and operations in mind"
            }
        ],
        ...
        statistics: [
            { value: "98,000+", label: "Design Drawings", description: "Produced for Riyadh Metro" },
            { value: "28,000", label: "Professionals", description: "At peak construction" },
            { value: "100+", label: "Mock-ups", description: "Created for testing" },
            { value: "10,000+", label: "Unique Designs", description: "For system components" }
        ],
        ...
        caseStudies: [
            {
                ...
                description: "The largest metro project in the world built in a single phase",
                image: "https://www.bechtel.com/wp-content/uploads/2024/12/KAFD-Steel-Structure-1-edited-900x506.webp",
                highlights: ["98,000 design drawings", "10,000 unique door designs", "120,000 as-built drawings"],
            ...
            },
            {
                ...
                image: "https://www.bechtel.com/wp-content/uploads/2025/01/1694565110427-506x365.webp",
                highlights: ["42km of new tunnels", "10 new stations", "BIM implementation"],
                                ...
                                <div key={index} className="flex gap-5 sm:gap-6 group">
                                    <div className="flex-shrink-0">
                                        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-white shadow-lg flex items-center justify-center group-hover:shadow-xl transition-shadow">
                                            <Icon className="w-7 h-7 sm:w-8 sm:h-8 text-red-600" />
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 max-w-6xl mx-auto">
                        {service.statistics.map((stat, index) => (
                            <div key={index} className="text-center group">
                                <div className="text-5xl sm:text-6xl md:text-5xl font-bold text-red-600 mb-3 font-apfel2">
                                    {stat.value}
                                </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 max-w-6xl mx-auto">
                        {service.capabilities.map((capability, index) => (
                            ...
                            >
                                <CheckCircle2 className="w-6 h-6 text-red-600 flex-shrink-0 group-hover:scale-110 transition-transform" />
            ...
            <section className="py-20 sm:py-24 md:py-32 bg-gray-50">
                <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24">
                    <div className="max-w-5xl mx-auto text-center">
                        <div className="text-7xl text-red-600/20 mb-8 font-serif leading-none">"</div>
                        <blockquote className="text-2xl sm:text-3xl md:text-4xl font-apfel2 text-gray-800 mb-8 leading-relaxed">
                            {service.testimonial.quote}
                        </blockquote>
                        <div className="text-gray-600">
                            <p className="font-semibold text-xl mb-1 font-neuhas">{service.testimonial.author}</p>
                            <p className="text-lg font-neuhas">{service.testimonial.company}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 sm:py-24 md:py-32">
                <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 text-center">
                    ...
                    <p className="text-xl sm:text-2xl mb-10 sm:mb-12 max-w-3xl mx-auto font-neuhas leading-relaxed">
                        Let's discuss how our {service.title.toLowerCase()} expertise can help deliver your next project with excellence.
                    </p>
