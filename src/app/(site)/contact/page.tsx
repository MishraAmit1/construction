...
export const metadata = {
    ...
    description: 'Contact A&T Infracon Pvt. Ltd. for road construction, border infrastructure, building works and civil projects across Gujarat, Rajasthan, J&K, and Ladakh.',
};
