...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How long has A&T Infracon been in business?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A&T Infracon Pvt. Ltd. has been a Civil Engineering Contractor for Road and Building Works for over 35 years, since 1989. We have successfully completed 100+ projects worth over ₹500 crores across Gujarat, Rajasthan, Jammu & Kashmir, and Ladakh."
      }
    },
    {
      "@type": "Question",
      "name": "What areas does A&T Infracon serve?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What is A&T Infracon's core competency?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What is A&T Infracon's annual turnover?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For the fiscal year 2023-2024, A&T Infracon recorded an annual turnover of Rs. 161.49 Crores. We have shown consistent growth with turnovers of Rs. 169.07 Cr (2022-23), Rs. 111.70 Cr (2021-22), Rs. 91.93 Cr (2020-21), and Rs. 51.09 Cr (2019-20)."
      }
    },
    {
      "@type": "Question",
      "name": "What equipment does A&T Infracon have?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Which organizations does A&T Infracon work with?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What makes A&T Infracon different from other contractors?",
      "acceptedAnswer": {
        "@type": "Answer",
...
const equipmentSchema = {
  ...
  "description": "Modern machinery and equipment owned by A&T Infracon",
  "itemListElement": [
    {
      "@type": "ListItem",
      "position": 1,
